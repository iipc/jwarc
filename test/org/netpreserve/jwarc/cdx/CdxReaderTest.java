...
public class CdxReaderTest {
    ...
    public void test() throws IOException {
        String data = "org,example)/ 20220302214434 http://example.org/ text/html 200 AQLNJ7DOPHK477BWWC726H7Y5XBPBNF7 - - 1062 760582405 example.warc.gz\n" +
        ...
        try (CdxReader reader = new CdxReader(new BufferedReader(new StringReader(data)))) {
            ...
            assertEquals(CdxFormat.CDX11, record.format());
            assertEquals("org,example)/", record.surt());
            assertEquals("org,example)/", record.values().get(0));
            ...
            assertEquals("org,example)/ 20220302214434 http://example.org/ text/html 200 AQLNJ7DOPHK477BWWC726H7Y5XBPBNF7 - - 1062 760582405 example.warc.gz",
                    record.toString());
